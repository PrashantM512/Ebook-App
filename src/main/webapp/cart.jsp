...
<body>
	...
	<c:if test="${not empty removed }">
		<div class="alert alert-success" role="alert">${removed}</div>
		<c:remove var="removed" scope="session" />
	</c:if>

	<c:if test="${not empty failedRemove }">
		<div class="alert alert-danger" role="alert">${failedRemove}</div>
		<c:remove var="removed" scope="session" />
	</c:if>
							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td><%=crt.getPrice()%></td>
										<td><a
											href="RemoveFromCart?cid=<%=crt.getCid()%>&&uid=<%=uid%>"
						...
						<table
							...
							<thead class="thead-dark">
								<tr style="background-color: #cfcfcf; height: 40px">
									...
									<th style="text-align: center;" scope="col"><c:out
											value="${total }"></c:out></th>
								</tr>
							</thead>
						</table>
					</div>
					...
					<div class="card-body">
						...
						<form action="OrderServlet?uid=${userObj.id }" method="post">
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="inputEmail4">Name</label> <input type="text"
										name="username" value="${userObj.name }" class="form-control"
										id="inputEmail4" readonly placeholder="Full Name">
								</div>
								<div class="form-group col-md-6">
									<label for="inputPassword4">Email</label> <input
										value="${userObj.email }" name="email" readonly type="email"
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="inputEmail4">Mobile no.</label> <input
										type="number" name="mobile" value="${userObj.phone }"
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									<label for="inputPassword4">Pincode</label> <input
										...
										id="inputPassword4" placeholder="Pincode" required>
								</div>
							</div>
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									<a href="new_books.jsp" style="width: inherit;" type="submit"
